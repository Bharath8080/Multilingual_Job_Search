...
# Main content area
st.markdown(
    f'<h1><img src="https://framerusercontent.com/images/9vH8BcjXKRcC5OrSfkohhSyDgX0.png" width="60" style="vertical-align: middle;"/> Multilingual Job Search<img src="https://cdn-icons-png.flaticon.com/512/2936/2936677.png" width="60" height="60" style="vertical-align: middle;"/></h1>',
    unsafe_allow_html=True
)
